...
Para jogar, disponibilizei o arquivo **projetofinal** que está compilado de **projetofinal.c**, Nele ao executar o comando: <br><br> **gcc projetofinal.c -o projetofinal.out** <br> Você poderá compilar(inclusive mudar o nome "projetofinal" para outro de preferência).
